...
## [26.4.0] - Aspose Words Cloud for Rust 26.4 Release Notes
...
## [26.3.0] - Aspose Words Cloud for Rust 26.3 Release Notes

- Various stability and performance improvements.


## [26.2.0] - Aspose Words Cloud for Rust 26.2 Release Notes

- Implemented ability to save documents as Docling JSON format.


## [26.1.0] - Aspose Words Cloud for Rust 26.1 Release Notes

- Add fontsLocation parameter for Compare API.


## [25.12.0] - Aspose Words Cloud for Rust 25.12 Release Notes

- Classification API has been removed.


## [25.11.0] - Aspose Words Cloud for Rust 25.11 Release Notes
...
## [25.8.0] - Aspose Words Cloud for Rust 25.8 Release Notes



## [25.6.0] - Aspose Words Cloud for Rust 25.6 Release Notes
...
## [25.5.0] - Aspose Words Cloud for Rust 25.5 Release Notes
...
## [25.4.0] - Aspose Words Cloud for Rust 25.4 Release Notes
...
## [25.2.0] - Aspose Words Cloud for Rust 25.2 Release Notes

- Added 'IdPrefix' property for HtmlFixedSaveOptionsData and SvgSaveOptionsData class.


## [24.12.0] - Aspose Words Cloud for Rust 24.12 Release Notes
...
## [24.11.0] - Aspose Words Cloud for Rust 24.11 Release Notes
...
## [24.9.0] - Aspose Words Cloud for Rust 24.9 Release Notes
...
## [24.4.0] - Aspose Words Cloud for Rust 24.4 Release Notes
...
## [24.3.0] - Aspose Words Cloud for Rust 24.3 Release Notes

- Added support for 'RemoveEmptyCells' option for the 'Cleanup' parameter in the insert 'MailMerge' API method.


## [24.1.0] - Aspose Words Cloud for Rust 24.1 Release Notes
...
## [23.12.0] - Aspose Words Cloud for Rust 23.12 Release Notes
...
## [23.11.0] - Aspose Words Cloud for Rust 23.11 Release Notes
...
## [23.9.0] - Aspose Words Cloud for Rust 23.9 Release Notes

- Support for class inheritance in responses from the server.


## [23.6.0] - Aspose Words Cloud for Rust 23.6 Release Notes

- Fix XMLHttpRequest in web applications.


## [23.5.0] - Aspose Words Cloud for Rust 23.5 Release Notes

- Added InsertSection method.


## [23.4.0] - Aspose Words Cloud for Rust 23.4 Release Notes

- Added new type of RangeEndIdentifier for RangeApi: document:end


## [23.3.0] - Aspose Words Cloud for Rust 23.3 Release Notes
...
## [23.2.0] - Aspose Words Cloud for Rust 23.2 Release Notes

- Added operations to manipulate with Structure Document Tags (SDT) in documents.


## [23.1.0] - Aspose Words Cloud for Rust 23.1 Release Notes

- Various changes related to stability and performance


## [22.12.0] - Aspose Words Cloud for Rust 22.12 Release Notes

- Various changes related to stability and performance


## [22.11.0] - Aspose Words Cloud for Rust 22.11 Release Notes

- Added 'EmbedAttachments' property for PdfSaveOptionsData class.


## [22.10.0] - Aspose Words Cloud for Rust 22.10 Release Notes
...
## [22.9.0] - Aspose Words Cloud for Rust 22.9 Release Notes
...
## [22.8.0] - Aspose Words Cloud for Rust 22.8 Release Notes

- Added optional loadEncoding and password parameters for ConvertDocument API method.


## [22.7.0] - Aspose Words Cloud for Rust 22.7 Release Notes
...
## [22.6.0] - Aspose Words Cloud for Rust 22.6 Release Notes
...
## [22.5.0] - Aspose Words Cloud for Rust 22.5 Release Notes

- Internal API fixes and improvments.


## [22.4.0] - Aspose Words Cloud for Rust 22.4 Release Notes

- Added ExportShapesAsSvg to HtmlSaveOption.
- Added new endpoint '~/styles/copy_from'.


## [22.3.0] - Aspose Words Cloud for Rust 22.3 Release Notes
...
## [22.2.0] - Aspose Words Cloud for Rust 22.2 Release Notes
...
## [22.1.0] - Aspose Words Cloud for Rust 22.1 Release Notes
...
## [21.12.0] - Aspose Words Cloud for Rust 21.12 Release Notes

- Added FieldOptions parameter to mail merge operations
- Added timeout parameter to api configuration


## [21.11.0] - Aspose Words Cloud for Rust 21.11 Release Notes



## [21.10.0] - Aspose Words Cloud for Rust 21.10 Release Notes
...
## [21.8.0] - Aspose Words Cloud for Rust 21.8 Release Notes
...
## [21.7.0] - Aspose Words Cloud for Rust 21.7 Release Notes
...
## [21.6.0] - Aspose Words Cloud for Rust 21.6 Release Notes
...
## [21.5.0] - Aspose Words Cloud for Rust 21.5 Release Notes

- Update dependencies in sdk


## [21.4.0] - Aspose Words Cloud for Rust 21.4 Release Notes
...
## [21.3.0] - Aspose Words Cloud for Rust 21.3 Release Notes
...
## [21.2.0] - Aspose Words Cloud for Rust 21.2 Release Notes

- Added delete all comments method


## [21.1.0] - Aspose Words Cloud for Rust 21.1 Release Notes

- Added online version for all API methods


## [20.11.0] - Aspose Words Cloud for Rust 20.11 Release Notes

- In configuration json file appSid / appKey has been replaced to clientId / clientSecret.
- In Words API initialization methods clientId parameter precedes clientSecret parameter.


## [20.10.0] - Aspose Words Cloud for Rust 20.10 Release Notes

- Internal API changes.


## [20.9.0] - Aspose Words Cloud for Rust 20.9 Release Notes

- Added Batch API feature


## [20.8.0] - Aspose Words Cloud for Rust 20.8 Release Notes
...
## [20.7.0] - Aspose Words Cloud for Rust 20.7 Release Notes

- Added 'Markdown' save format
- Added endpoint to update paragraph format without node path (PUT '/words/{name}/paragraphs/{index}/format')


## [20.6.0] - Aspose Words Cloud for Rust 20.6 Release Notes
...
## [20.5.0] - Aspose Words Cloud for Rust 20.5 Release Notes
